...
For the full request/response reference, headers, error codes, and supported filters — including the [`connector`](../payment-methods#connector) object that identifies each method's gateway and processor — see the [Payment Methods API page](../payment-methods).
