...
<ThemedImage
  alt="Screenshot placeholder — the Checkout SDK rendering the wallet entry alongside other payment methods"
  sources={{
    light: useBaseUrl('/img/wallet-checkout-placeholder.svg'),
    dark: useBaseUrl('/img/wallet-checkout-placeholder.svg'),
  }}
/>
