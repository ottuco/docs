...
Try the wallet flow below. The demo uses a fresh customer per click, then launches the Checkout SDK with wallet enabled. Screenshots of the merchant-side flow are on the [business wallet pages](/business/wallet/).
