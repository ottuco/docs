...
The demo below seeds a fresh wallet on the fly for a generated customer, then launches the Checkout SDK with wallet enabled. The seeding step relies on the public sandbox wallet endpoint (Redmine subticket 150892); until that ships, the demo will surface a clear error during the "Setting up your demo wallet…" step. Screenshots of the merchant-side flow are on the [business wallet pages](/business/wallet/).
...
#### Can I charge a wallet without the Checkout SDK?
