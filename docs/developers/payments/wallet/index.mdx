...
<ThemedImage
  alt="Customer applies wallet credit at checkout — the Checkout SDK rendering the wallet entry alongside other payment methods (placeholder; real screenshot coming soon)"
  sources={{
    light: useBaseUrl('/img/wallet-checkout-placeholder.png'),
    dark: useBaseUrl('/img/wallet-checkout-placeholder.png'),
  }}
/>
