...
<FAQ>
  ...
  <FAQItem question="What authentication does the Payment Status Query API support?">
    Both [API Key](/developers/getting-started/authentication#api-key-auth) and [Basic Authentication](/developers/getting-started/authentication#basic-auth). No special permissions required for Basic Auth beyond `payment.inquiry`.
  </FAQItem>
