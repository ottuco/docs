...
<FAQ>
  <FAQItem question="1. What is the Ottu Checkout API used for?">
  ...
  <FAQItem question="2. How do I create a payment transaction?">
  ...
  <FAQItem question="3. How can I ensure that the payer cannot make a payment after a certain amount of time since redirection?">
  ...
  <FAQItem question="4. Can I update an existing transaction?">
  ...
  <FAQItem question="5. What happens if a customer abandons the payment?">
  ...
  <FAQItem question="6. How do I get notified when a payment is completed?">
    Ottu sends a [payment notification](../webhooks/payment-events.md) webhook to the `webhook_url` you provided in the API request. The webhook contains details like `status`, `amount`, `currency_code`, and [`pg_params`](../webhooks/pg-params) (normalized gateway response fields). Ensure your server verifies and processes these webhook notifications.
  </FAQItem>

  <FAQItem question="7. What is the difference between `webhook_url` and `redirect_url`?">
  ...
  <FAQItem question="8. Can I retry a failed payment?">
    Yes, if a transaction fails, you can reuse the same `session_id`. The payment state will be `attempted`. For more information, please refer to [Payment States](../reference/payment-states.md).
  </FAQItem>

  <FAQItem question="9. Can I set up recurring payments using the Checkout API?">
    Yes! Use [Auto-Debit](../cards-and-tokens/recurring-payments.md) with `payment_type` set to `auto_debit` to create agreements for recurring transactions.
  </FAQItem>

  <FAQItem question="10. How do I integrate the Checkout API with the SDK?">
  ...
  <FAQItem question="11. What are the benefits of One-Step Checkout?">
  ...
  <FAQItem question="12. Can the `file_url` from an upload be reused for other transactions?">
    Yes, Ottu allows merchants to use a `file_url` generated from any upload for different and multiple transactions.
  </FAQItem>

  <FAQItem question="13. How do I handle errors from the Upload Attachment API?">
    The API will return detailed error messages in the response body when an issue occurs, such as unsupported file types, invalid `session_id`, or file size limits being exceeded. Implement error handling in your code to display appropriate messages to users.
  </FAQItem>

  <FAQItem question="14. What is `file_url`, and where can I use it?">
