...
- A subsequent [auto-debit](../cards-and-tokens/recurring-payments.mdx) payment using a stored token.
...
|     `token`     | Token-based stored or recurring payment | [Auto-debit](../cards-and-tokens/recurring-payments.mdx) or saved card tokenized payments |
...
<FAQItem question="Can I set up recurring payments using the Checkout API?">
  Yes! Use [Auto-Debit](../cards-and-tokens/recurring-payments.mdx) with
...
- [**Recurring Payments**](../cards-and-tokens/recurring-payments.mdx) — Set up auto-debit using saved cards
