...
#### 1. What is the Ottu Checkout API used for?
...
#### 2. How do I create a payment transaction?
...
#### 3. How can I ensure that the payer cannot make a payment after a certain amount of time since redirection?
...
#### 4. Can I update an existing transaction?
...
#### 5. What happens if a customer abandons the payment?
...
#### 6. How do I get notified when a payment is completed?
...
#### 7. What is the difference between `webhook_url` and `redirect_url`?
...
#### 8. Can I retry a failed payment?
...
#### 9. Can I set up recurring payments using the Checkout API?
...
#### 10. How do I integrate the Checkout API with the SDK?
...
#### 11. What are the benefits of One-Step Checkout?
...
#### 12. Can the `file_url` from an upload be reused for other transactions?

Yes, Ottu allows merchants to use a `file_url` generated from any upload for different and multiple transactions.

#### 13. How do I handle errors from the Upload Attachment API?
...
#### 14. What is `file_url`, and where can I use it?
