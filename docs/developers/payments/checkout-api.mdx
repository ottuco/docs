...
- [Private API Key](/developers/getting-started/authentication#private-key-api-key)
- [Basic Authentication](/developers/getting-started/authentication#basic-authentication)
...
One-Step Checkout combines the [Checkout API](./checkout-api) and the [Native Payments](./native-payments)into a single backend request.\
...
:::tip Try it live
See One-Step Checkout in action with a saved token on the [Recurring Payments live demo](../cards-and-tokens/recurring-payments#live-demo).
:::
...
<FAQItem question="Can I set up recurring payments using the Checkout API?">
  Yes! Use [Auto-Debit](../cards-and-tokens/recurring-payments.md) with
  ...
  <FAQItem question="What are the benefits of One-Step Checkout?">
    ...
    - Consistent structure with [Native Payments](./native-payments).
...
- [**Checkout SDK**](./checkout-sdk/) — Drop-in UI for web and mobile that uses the Checkout API
...
- [**Recurring Payments**](../cards-and-tokens/recurring-payments.md) — Set up auto-debit using saved cards
