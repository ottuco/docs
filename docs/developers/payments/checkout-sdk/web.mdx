...
If `'jazz'` is omitted, or if a payment method has not been enabled for onsite checkout, the Checkout SDK falls back automatically to the standard redirect-to-gateway flow for that method.
