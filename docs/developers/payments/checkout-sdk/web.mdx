...
<StepGuide steps={[
  ...
  {
    title: "Try it",
    description: <>The live demo seeds a fresh wallet for a generated customer_id and launches the SDK with wallet enabled. Use the demo on the <a href="/developers/payments/wallet/">Wallet overview page</a>.</>,
