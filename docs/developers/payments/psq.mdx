...
**PSP & PTSP handling (e.g., MyFatoorah):**

Some PSP and PTSP integrations may return a `pending` status even after the customer is redirected back. This happens when the underlying gateway hasn't provided a definitive response yet. In these cases:
