...
<StepGuide steps={[
  {
    ...
    description: <>Provide at least one identifier — <code>session_id</code> or <code>order_no</code>:<br /><br /><pre><code>{`curl -X POST "${OTTU_CONNECT_BASE_URL}/b/pbl/v2/inquiry/" \\
