...
<FAQ>
  <FAQItem question="What is Ottu's Invoice API?">
  ...
  <FAQItem question="Why should I use it?">
  ...
  <FAQItem question="Can I skip the Payment Methods API?">
