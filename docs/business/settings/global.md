...
| **Enable URL shortener** | Activates the URL shortener for public payment links. See [URL Shortener Configuration](./url-shortener.md) for setup details |

## What's Next?

- **[Webhooks Configuration](./webhooks.md)** — Set up real-time notifications for payment and operation events
- **[API Keys](./api-keys.mdx)** — Generate API keys for developer integration
