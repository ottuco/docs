...
:::tip
Most merchants use the Hosted Checkout or SDK approach, which keeps their PCI burden minimal. See the [Developer Documentation](/developers/payments/checkout-sdk/) for integration options.
:::
...
- **[Payment Gateways](/business/payments/gateways)** — All gateways meet Ottu's security standards
- **[Settings](/business/settings/)** — Configure security settings in the dashboard
- **For developers**: [Webhook Signature Verification](/developers/webhooks/verify-signatures)
