...
- **Seamless payment integration** — Integrate with popular e-commerce platforms (WooCommerce, Magento, OpenCart, and more). See the [platform compatibility table](./index.mdx#e-commerce-platform-compatibility) for the full list.
...
- [Plugins Overview](./index.mdx) — See all available plugins and platform compatibility
