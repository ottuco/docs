...
:::tip
Start with [Refund & Void Access Control](./refund-void-access-control.md) to understand the permission model, then read [Two-Step Authorization](./two-step-authorization.mdx) to set up the approval workflow.
:::
