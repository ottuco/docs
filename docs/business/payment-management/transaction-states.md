...
| **Refunded**        | Authorized / Paid | A partial or full refund has been returned to the customer (to the original gateway or to the customer's [M-Wallet](/business/wallet#refund-to-wallet)). |
