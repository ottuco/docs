...
Ottu provides a seamless workflow for merchants to process advance payments. To initiate an advance payment, follow the steps described in [Triggering Contract Actions](/docs/business/industry/real-estate/tenant-contract/contract-management#triggering-contract-actions).
...
- [Auditing](/docs/business/industry/real-estate/auditing) -- Roll back an advance payment if needed
