  ...
  steps={[
    {
      ...
      description: (
        <>
          <ol>
            <li>
              Click <strong>Add Unit Type with Units</strong> at the bottom of
              the New Property Form to open the unit details form.
            </li>
            <li>
              Click <strong>ADD OR EDIT UNITS</strong> to specify the number of
      ...
      image:
        "/img/business/real-estate/getting-started/gs-01-add-edit-units.png",
      imageAlt: "Add or edit units",
    },
    {
      title: "Define Unit Details",
      description: (
        <>
          Click the <strong>ADD</strong> button to define the details of these
          units, then fill in the required information.
        </>
      ),
      image:
        "/img/business/real-estate/getting-started/gs-02-define-unit-details.png",
      imageAlt: "Define unit details",
    },
    {
      title: "Save the Property",
      description: (
        <>
          Save the property to make it available for actions like tenant
          assignment or contract creation.
          <br />
          <br />
          Refer to the{" "}
          <a href="/docs/business/industry/real-estate/properties">
            Property Management
          </a>{" "}
          section for further details on managing property settings and custom
          fields.
        </>
      ),
      image:
        "/img/business/real-estate/getting-started/gs-03-unit-info-form.png",
      imageAlt: "Unit information form",
    },
  ]}
/>
...
![Invoices while contracting](/img/business/real-estate/getting-started/gs-04-invoices-contracting.png)
...
![Unit vacancy report](/img/business/real-estate/getting-started/gs-05-vacancy-report.png)
...
![Displayed invoices](/img/business/real-estate/getting-started/gs-06-displayed-invoices.png)
...
![Invoice PDF report](/img/business/real-estate/getting-started/gs-07-invoice-pdf.png)
...
![Payment page](/img/business/real-estate/getting-started/gs-08-payment-page.png)
...
![Manual payment option](/img/business/real-estate/getting-started/gs-09-manual-payment.png)
