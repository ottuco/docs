...
:::warning
Operations only work when the payment currency matches the MID currency. If a customer pays in a different currency via [currency exchange](/business/payments/currencies), operations won't function. See [Operations](/developers/operations/) for technical details.
:::
...
- **[Currencies](/business/payments/currencies)** — Multi-currency support and exchange configuration
- **[Operations & Controls](/business/operations/)** — Refund and void access control, two-step authorization
- **For developers:** [Payment Status Inquiry](/developers/reference/payment-status-inquiry) — auto-inquiry and transaction reliability
